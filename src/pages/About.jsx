...
const About = () => {
  ...
  return (
    <Layout fullWidth>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-navy-300 mb-4">
              ...
              <div className="bg-gray-100 dark:bg-navy-800 rounded-2xl p-8 text-center">
                <div className="bg-usa-red rounded-xl p-6 inline-block mb-4">
                  <Truck className="h-16 w-16 text-white" />
                </div>
                <div className="text-4xl font-bold text-navy dark:text-white mb-2">500+</div>
                <div className="text-gray-600 dark:text-navy-300">Signs Delivered</div>
      ...
      {/* FAQ */}
      <section id="faq" className="py-16 lg:py-24 bg-gray-50 dark:bg-navy-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`h-5 w-5 text-gray-500 dark:text-navy-400 transition-transform ${
                        expandedFaq === index ? 'rotate-180' : ''
                      }`}
                    />
                  </button>
                  {expandedFaq === index && (
                    <div className="px-6 pb-4 text-gray-600 dark:text-navy-300">{faq.answer}</div>
                  )}
                </div>
              ))}
            </div>
      ...
      {/* Contact */}
      <section id="contact" className="py-16 lg:py-24 bg-white dark:bg-navy-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-navy/10 dark:bg-navy-700 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Phone className="h-6 w-6 text-navy dark:text-navy-300" />
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900 dark:text-white">Phone</div>
                      <div className="text-gray-600 dark:text-navy-300">(555) 123-4567</div>
                    </div>
                  </div>

                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-navy/10 dark:bg-navy-700 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Mail className="h-6 w-6 text-navy dark:text-navy-300" />
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900 dark:text-white">Email</div>
                      <div className="text-gray-600 dark:text-navy-300">info@trucksigns.com</div>
                    </div>
                  </div>

                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-navy/10 dark:bg-navy-700 rounded-xl flex items-center justify-center flex-shrink-0">
                      <MapPin className="h-6 w-6 text-navy dark:text-navy-300" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-navy/10 dark:bg-navy-700 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Clock className="h-6 w-6 text-navy dark:text-navy-300" />
                    </div>
                    <div>
